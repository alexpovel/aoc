...
#[derive(PartialEq, Debug, Clone, Copy, PartialOrd, Ord, Eq)]
enum Hand {
    FiveOfAKind(Cards),
    FourOfAKind(Cards),
    FullHouse(Cards),
...
impl From<Cards> for Hand {
    fn from(cards: Cards) -> Self {
        ...
        match (
            ...
            (true, true, true, false) | (false, true, true, true) => Self::FourOfAKind(cards),

            (true, false, true, true) | (true, true, false, true) => Self::FullHouse(cards),

            (true, true, false, false)
            | (false, true, true, false)
            | (false, false, true, true) => Self::ThreeOfAKind(cards),

            (true, false, true, false)
            | (true, false, false, true)
            | (false, true, false, true) => Self::TwoPair(cards),

            (true, false, false, false)
            | (false, true, false, false)
            | (false, false, true, false)
            | (false, false, false, true) => Self::OnePair(cards),

            (false, false, false, false) => Self::HighCard(cards),
        }
    }
}
...
impl Challenge for Part {
    ...
    fn solve(&self) -> String {
        ...
        hands.sort_by_key(|(h, _)| h.to_owned());
